...
export declare type ReqRespAPIType<RequestType extends BaseRequestType, ResponseType extends BaseResponseType, RuntimeErrorTypes extends Error, name extends string> = {
    name: name;
    APIType: 'ReqRespAPIType';
};
export declare type UnpackReqRespAPIType<T extends ReqRespAPIType<any, any, any, any>> = T extends ReqRespAPIType<infer RequestType, infer ResponseType, infer PossibleRuntimeErrorTypes, infer name> ? {
