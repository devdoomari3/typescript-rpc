...
export declare abstract class BaseAPIServer {
    ...
    addAPI<APIType extends ReqRespAPIType<any, any, any, any>>(api: APIType, handler: (req: UnpackReqRespAPIType<APIType>['RequestType']) => Promise<CleanedResponseType<UnpackReqRespAPIType<APIType>['ResponseType']>>): void;
